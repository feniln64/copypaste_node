...
#resource "aws_s3_bucket_intelligent_tiering_configuration" "data-entire-bucket-tiering" {
...
resource "aws_s3_bucket_analytics_configuration" "data-entire-bucket-analytics" {
  bucket = aws_s3_bucket.data_bucket.bucket
  name   = "EntireBucket"
...
resource "aws_s3_bucket_lifecycle_configuration" "data-lifecycle" {
  bucket = aws_s3_bucket.data_bucket.id
