...
router.route('/create/public/:userId').post(logging,contentController.createNewContentPublic) // /content/create/:userId
...
router.route('/update/public/:contentId').patch(logging,contentController.updateContentByContentId)  // /content/update/:contentId
