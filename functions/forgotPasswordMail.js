...
const forgotPasswordMail = async (email, url) => {
    var RESET_URL = url
    const emailData = {
        Content: {
            Body: [
                        ...
                        <tr>
                            ...
                            <![endif]-->
                                <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="contentMainTable">
                                    ...
                                    <td style="background-color:#EFEFEF;line-height:30px;font-size:30px;width:100%;min-width:100%">&nbsp;</td>
                                    </tr>
                                    <tr class="wp-block-editor-imageblock-v1">
                                    <td style="background-color:#EFEFEF;padding-top:20px;padding-bottom:20px;padding-left:20px;padding-right:20px" align="center">
                                    <table align="center" width="168" class="imageBlockWrapper" style="width:168px" role="presentation">
                                    <tbody>
                                    <tr>
                                    <td style="padding:0">
                                    <img src="https://api.smtprelay.co/userfile/29b1eda2-c583-40d9-abd5-83c12c8aecd0/image.png" width="168" height="" alt="" style="border-radius:0px;display:block;height:auto;width:100%;max-width:100%;border:0" class="g-img"></td></tr></tbody></table></td></tr><tr class="wp-block-editor-headingblock-v1">
                                        <td valign="top" style="background-color:#fff;display:block;padding-top:40px;padding-right:20px;padding-bottom:20px;padding-left:20px">
                                            <p style="font-family:Helvetica, sans-serif;line-height:32.20px;font-size:28px;background-color:#fff;color:#616262;margin:0;word-break:normal" class="heading1">
                                                To Reset Password <span style="color:#05a49a">Click below..</span>
                                            </p>
                                        </td>
                                    </tr>
                                    <tr class="wp-block-editor-paragraphblock-v1">
                                        <td valign="top" style="padding:0px 20px 20px 20px;background-color:#fff">
                                            <p class="paragraph" style="font-family:Helvetica, sans-serif;line-height:1.5;font-size:14px;margin:0;color:#5f5f5f;word-break:normal">
                                                Please click bewlow to reset your password. if that does not work copy this url and paste in browser.
                                                <a target="_blank" rel="noreferrer noopener" href="${RESET_URL}">${RESET_URL}</a>.  
                                                The link will expire in 1 hour.
                                            </p>
                                        </td>
                                    </tr>
                                    <tr class="wp-block-editor-buttonblock-v1" align="center"><td style="background-color:#fff;padding-top:40px;padding-right:20px;padding-bottom:40px;padding-left:20px;width:100%" valign="top"><table role="presentation" cellspacing="0" cellpadding="0" class="button-table">
                                        <tbody>
                                    <tr>
                                    <td valign="top" class="button-td button-td-primary" style="cursor:pointer;border:none;border-radius:4px;background-color:#8e1f2c;font-size:16px;font-family:Helvetica, sans-serif;width:fit-content;color:#ffffff"><a style="color:#ffffff" href="{url}">
                                    ...
                                    <tr>
                                      ...
                                      <td valign="top" style="
                                        cursor: pointer; border: none; border-radius: 4px; background-color: #8e1f2c; font-size: 16; font-family: Helvetica, sans-serif; width: fit-content; letter-spacing: undefined;
                                          ...
                                          display: block;
                                          padding: 0;
                                        "><a href="${RESET_URL}" style="text-decoration: none; color:white">
                                        Reset Password
                                        </a>
