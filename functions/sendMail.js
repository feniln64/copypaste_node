// create export function to send email function with mailjet
                                 ...
                                 <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                                             ...
                                             <table border="0" cellpadding="0" cellspacing="0">
                                               <tr>
                                                 <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;">
                                                   <a href="${BASE_URL}/auth/varify/email/${options.emailVarifyToken}" target="_blank"
                                   ...
                                   <tr>
                                     <td align="left" bgcolor="#ffffff"
                                       ...
                                       <p style="margin: 0;"><a href="${BASE_URL}/auth/varify/email/${options.emailVarifyToken}"
